...
import styles from './GalleryReviews.module.css';

const gallery = [
  'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=500&h=420&fit=crop',
  'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=500&h=420&fit=crop',
  'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=500&h=420&fit=crop',
  'https://images.unsplash.com/photo-1601058268499-e52658b8bb88?w=500&h=420&fit=crop',
  'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=500&h=420&fit=crop',
  'https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?w=500&h=420&fit=crop',
];
...
export default function GalleryReviews() {
  ...
  return (
    <>
      <section className={`${styles.galleriSection} shell`} aria-labelledby="galleri-title">
        <div className={styles.galleriBox}>
          <h2 id="galleri-title" className={styles.galleriTitle}>Galleri</h2>
          <div className={styles.galleriGrid}>
            {gallery.map((src, i) => (
              <div key={i} className={styles.galleriItem}>
                <img src={src} alt="Behandling på Citylaser" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className={`${styles.reviewsSection} shell`} aria-label="Kundomdömen">
